...
class StreamDSL {
     ...
     * @param producerReadyCallback
     * @param producerErrorCallback
     * @returns {StreamDSL}
     */
    to(topic, outputPartitionsCount = 1, producerReadyCallback = null, producerErrorCallback = null){

        //TODO wrap producerReadyCallback into promise stream.to().then()
        ...
        this.kafka.setupProducer(this.outputTopicName, this.outputPartitionsCount,
            producerReadyCallback || NOOP, producerErrorCallback || NOOP);
